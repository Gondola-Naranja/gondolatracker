...
gondola1 = Gondola.find_or_initialize_by(plate: 'GNOX 1234')
gondola1.last_location = 'Patio Chatarra 1'
gondola1.created_at = 30.days.ago
gondola1.save!

gondola2 = Gondola.find_or_initialize_by(plate: 'FXE 5678')
gondola2.last_location = 'Patio Chatarra 2'
gondola2.created_at = 15.days.ago
gondola2.save!

gondola3 = Gondola.find_or_initialize_by(plate: 'CITX 002')
gondola3.last_location = 'Patio Chatarra 1'
gondola3.save!

gondola4 = Gondola.find_or_initialize_by(plate: 'KCSM 024')
gondola4.last_location = 'Patio Chatarra 2'
gondola4.save!

gondola5 = Gondola.find_or_initialize_by(plate: 'DEAX 102')
